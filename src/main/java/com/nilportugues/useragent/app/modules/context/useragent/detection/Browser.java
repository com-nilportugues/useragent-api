...
public class Browser extends VersionedObject {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Browser))
            return false;
        Browser d = (Browser) o;
        if (d.getFamily() == null && family != d.getFamily())
            return false;
        ...
        if (d.vendor == null && vendor != d.vendor)
            return false;
        if (d.fullVersion == null && fullVersion != d.fullVersion)
            return false;
        if (d.renderingEngine == null && renderingEngine != d.renderingEngine)
            return false;
        return ((d.getFamily() == null && family == null) || d.getFamily().equals(family)) &&
