...
public class UserAgentDetectionResult {
    ...
    private boolean botEquals(Bot a, Bot b) {
        if ((a == null || a.getFamily() == null) && (b == null || b.getFamily() == null))
            return true;
        if ((a == null || a.getFamily() == null) || (b == null || b.getFamily() == null))
            return false;
        return a.equals(b);
    ...
    public boolean equals(Object o) {
        if (o == null)
            return false;
        if (!(o instanceof UserAgentDetectionResult))
            return false;
        UserAgentDetectionResult d = (UserAgentDetectionResult) o;
        return botEquals(d.bot, bot) &&
    ...
    public String diff(Object o) {
        ...
        if (!(o instanceof UserAgentDetectionResult))
            return "!this.class";
        UserAgentDetectionResult d = (UserAgentDetectionResult) o;
        if (!objectEquals(d.device, device))
            return "device";
        if (!botEquals(d.bot, bot))
            return "bot";
        if (!objectEquals(d.browser, browser))
            return "browser";
        if (!objectEquals(d.locale, locale))
            return "locale";
        if (!objectEquals(d.unknownTokens, unknownTokens))
            return "unknownTokens";
        if (!objectEquals(d.operatingSystem, operatingSystem))
            return "os";
        return "==";
    }
